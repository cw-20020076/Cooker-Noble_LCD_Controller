...
struct Typography
{
    ...
    static const touchgfx::FontId MODE = 1;
    static const touchgfx::FontId KEYBOARD = 2;
};

struct TypographyFontIndex
{
    static const touchgfx::FontId DISPLAY = 0;  // RobotoCondensed_Regular_28_4bpp
    static const touchgfx::FontId MODE = 1;     // RobotoCondensed_Regular_24_4bpp
    static const touchgfx::FontId KEYBOARD = 2; // RobotoCondensed_Regular_20_4bpp
